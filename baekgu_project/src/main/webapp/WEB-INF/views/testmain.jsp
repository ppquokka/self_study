            ...
            <div class="col-md-8">
                ...
                <div class="input-group mb-3">
                    <form actions="/carInfor/selectSearch" method="get">
                        <select class="form-select" name="search">
                            ...
                            <option value="YEAR" <%= (searchStr.equals("YEAER")) ? "selected" : "" %>>NAME</option>
                ...
                <table class="table">
                    ...
                    <tr>
                            ...
                            <td>
                                <button formaction="/PetDiary/deleteAndSelectSearch" formmethod="post">Del</button>
                            </td>
                    </tr>
                    </form>
                    <%
